...
import { ArrowLeft, CheckCircle, Lock, Play, Network } from 'lucide-react';
...
export default function FacilitatorPathPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-green-600 to-green-700 px-6 py-12 text-white">
        <div className="mx-auto max-w-5xl">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Facilitator Path</h1>
              <p className="text-green-100">Enable payments</p>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="h-2 overflow-hidden rounded-full bg-green-800/50">
              <div
            ...
            return (
              ...
              >
                <div className="flex items-start gap-6 p-6">
                  ...
                  {isAvailable && (
                    <Link
                      href={`/learn/facilitator/${lesson.id}`}
        ...
        {completedCount === totalLessons && (
          <div className="mt-12 rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-green-100/50 p-8 text-center">
            ...
            <p className="mb-6 text-green-800">
              You've completed the Facilitator Path. You're now ready to build or host facilitators for x402!
            </p>
