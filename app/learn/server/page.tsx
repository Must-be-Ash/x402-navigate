...
import { ArrowLeft, CheckCircle, Lock, Play, Server } from 'lucide-react';
...
export default function ServerPathPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-purple-600 to-purple-700 px-6 py-12 text-white">
        <div className="mx-auto max-w-5xl">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Server Path</h1>
              <p className="text-purple-100">Accept payments</p>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="h-2 overflow-hidden rounded-full bg-purple-800/50">
              <div
        ...
        {completedCount === totalLessons && (
          <div className="mt-12 rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-green-100/50 p-8 text-center">
            ...
            <p className="mb-6 text-green-800">
              You've completed the Server Path. You're now ready to build payment-gated APIs with x402!
            </p>
